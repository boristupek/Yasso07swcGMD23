...
#path.func <- '/hsan2/khk/ghg/2013/soil/functions/'
#source(paste0(path.func,"biomass.core.r"))
...
repola.pine.above <- function(d13rm, ht) {  dk <- 2+1.25*d13rm
                                            return(ma.tot.m1(dk,ht))
}
repola.spruce.above <- function(d13rm, ht) {  dk <- 2+1.25*d13rm
                                              return(ku.tot.m1(dk,ht))
}
repola.birch.above <- function(d13rm, ht) {  dk <- 2+1.25*d13rm
...
repola.spruce.roots <- function(d13rm) {  dk <- 2+1.25*d13rm
...
repola.birch.roots <- function(d13rm, ht) {  dk <- 2+1.25*d13rm  
