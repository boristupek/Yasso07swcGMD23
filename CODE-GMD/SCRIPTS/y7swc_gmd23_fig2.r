...
#tSOC <- read.delim( "D:/LUKE/PAPER-BG20/SUBMISSION/GMD23_YassoSWC/CODE-GMD/DATA/tSOC_19.06.23.csv", header = T, skip = 0, sep=";")
#tSOCw <- read.delim("D:/LUKE/PAPER-BG20/SUBMISSION/GMD23_YassoSWC/CODE-GMD/DATA/tSOCw_19.06.23.csv", header = T, skip = 0, sep=";")
#tSOC.ci1 <- read.delim( "D:/LUKE/PAPER-BG20/SUBMISSION/GMD23_YassoSWC/CODE-GMD/DATA/tSOC.ci1_19.06.23.csv", header = T, skip = 0, sep=";")
#tSOC.ci99<- read.delim("D:/LUKE/PAPER-BG20/SUBMISSION/GMD23_YassoSWC/CODE-GMD/DATA/tSOC.ci99.06.23.csv", header = T, skip = 0, sep=";")
...
#load(paste("D:/LUKE/P_PAPER-BG20/DATA-BG/","SOC.ci_kgm2_ft9_13.02.20.RData",sep=""))
